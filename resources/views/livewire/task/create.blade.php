    ...
    <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
      ...
      <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        <div class="">
          ...
          <div class="mb-4">
            <label for="projectSelect" class="block text-gray-700 text-sm font-bold mb-2">Project:</label>
            <select 
                id="projectSelect"
                wire:model="project" 
          ...
          <div class="mb-4">
              <label for="exampleFormControlInput2" class="block text-gray-700 text-sm font-bold mb-2">Priority:</label>
              <select 
                id="projectSelect"
                wire:model="priority" 
                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
            ...
            @error('prority') <span class="text-red-500">{{ $message }}</span>@enderror
          </div>
        </div>
      </div>
